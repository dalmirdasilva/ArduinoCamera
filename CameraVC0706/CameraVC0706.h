...
public:
    ...
    enum DownSize {
        NO_ZOON = 0x00, HALF_SIZE = 0x01, QUARTER_SIZE = 0x02
    };
     ...
     */
    bool setDownSize(unsigned char widthDownSize,
     ...
     * @return               A frame.
     */
    unsigned int readFrame(unsigned char *buf, unsigned int frameOffset,
     ...
     */
    bool setHorizontalMirror(unsigned char by,
     ...
     */
    bool setColorControl(unsigned char by,
     ...
     * Stop alarm-output.
     */
    bool setMotionControl(unsigned char motionControl,
     ...
     */
    bool pollMotionMonitoring(unsigned int timeout,
            void (*callback)(void *));
     ...
     */
    bool setOsdCharacters(unsigned char x, unsigned char y,
     ...
     */
    bool executeCommand(unsigned char cmd, unsigned char *args,
...
private:
     ...
     */
    unsigned int sendCommand(unsigned char cmd, unsigned char *args,
            unsigned int argc);
